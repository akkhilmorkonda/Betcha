...
import { CATEGORIES } from "@betcha/core";
 ...
 */
// Defence 1 moved to @betcha/core/templates: it is a pure rule the client
// needs too. Re-exported so this module remains the one place to look for
// content safety.
export {
